...
<body>
    ...
    <form method="POST" action="{{ route('pelanggan.update', $pelanggan) }}">
        ...
        <label>Alamat</label>
        <textarea name="address">{{ old('address', $pelanggan->address) }}</textarea>
        ...
        <input type="text" name="latitude" value="{{ old('latitude', $pelanggan->latitude) }}">

        <label>Longitude</label>
        <input type="text" name="longitude" value="{{ old('longitude', $pelanggan->longitude) }}">
