...
<head>
    ...
    <style>body{font-family:Arial,sans-serif;background:#f8fafc;padding:24px;} .receipt{max-width:700px;background:#fff;padding:24px;border:1px solid #e2e8f0;border-radius:12px;} h1{margin-top:0;} .field{margin-bottom:12px;} .field strong{display:block;color:#334155;} .button{display:inline-flex;padding:10px 16px;border-radius:10px;background:#0f172a;color:#fff;text-decoration:none;}</style>
</head>
<body>
    <div class="receipt">
