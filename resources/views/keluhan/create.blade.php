...
@csrf
<div><label>Pelanggan (opsional)</label><select name="pelanggan_id"><option value="">-</option>@foreach($pelanggans as $pelanggan)<option value="{{ $pelanggan->id }}">{{ $pelanggan->kode_pelanggan }} - {{ $pelanggan->name }}</option>@endforeach</select></div>
