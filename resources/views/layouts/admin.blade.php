...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;} body{margin:0;font-family:'Inter',sans-serif;color:var(--text);background:var(--bg);} .admin-shell{display:grid;grid-template-columns:260px 1fr;min-height:100vh;}
        .sidebar{background:#0f172a;color:#e2e8f0;padding:24px 18px;} .brand{font-size:1.05rem;font-weight:700;display:flex;gap:10px;align-items:center;margin-bottom:20px;} .brand-logo{width:34px;height:34px;border-radius:10px;object-fit:cover;} .brand-fallback-mark{display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:10px;background:linear-gradient(135deg,#0ea5e9,#14b8a6);font-size:.8rem;font-weight:800;color:#f8fafc;} .brand-text{line-height:1.2;}
